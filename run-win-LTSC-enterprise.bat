...
echo.
mklink "C:\Program Files\Git\hair-brush-reminder-windows-version.sh" "C:\Users\%username%\hair-brush-reminder-windows-version.sh"
echo.
echo ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.\wt.exe wt.exe "C:\Program Files\Git\git-bash.exe" --hide -c "bash ../hair-brush-reminder-windows-version.sh"
cd /D "%~dp0"
